...
class MyApp extends StatelessWidget {
  ...
  final List<ActionsInfo> result = parseLoginInfo('''[{"description": "Decide what your child will eat", "parent_name": "Jay", "child_name": "Steven"}, 
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: CheckInScreen(infoMetric: result)
    );
  }
}
